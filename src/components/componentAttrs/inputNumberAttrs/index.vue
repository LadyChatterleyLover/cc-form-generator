<template>
  <el-form label-width="90px">
    ...
    <el-form-item label="默认值">
      <el-input-number v-model="current.value" placeholder="请输入默认值" clearable></el-input-number>
    </el-form-item>
    ...
    <el-form-item label="精度">
      <el-input-number v-model="current.attrs.precision" placeholder="请输入精度" clearable></el-input-number>
    </el-form-item>
    ...
    <el-form-item label="按钮方向" v-if="current.attrs.controls">
      <el-select v-model="current.attrs.controlsPosition" placeholder="请选择按钮方向">
    ...
    <el-form-item label="控制按钮">
      <el-switch v-model="current.attrs.controls"></el-switch>
    </el-form-item>
